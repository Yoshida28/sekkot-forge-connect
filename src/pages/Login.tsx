...
const Login = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    // In a real app, you would implement the login functionality here
    console.log('Login with:', { loginEmail, loginPassword });
  };

  const handleSignup = (e: React.FormEvent) => {
    e.preventDefault();
    // In a real app, you would implement the signup functionality here
  ...
  const handleVerifyOtp = (e: React.FormEvent) => {
    e.preventDefault();
    // In a real app, you would implement the OTP verification here
                ...
                <TabsContent value="signup">
                  {!showOtpField ? (
                    ...
                    <form onSubmit={handleVerifyOtp} className="space-y-4">
                      <div className="space-y-2">
                        <label htmlFor="otp" className="text-sm font-medium text-gray-200">Verification Code</label>
                        <p className="text-xs text-gray-400 mb-2">We've sent a verification code to your email address.</p>
                        <Input
                          id="otp"
                          type="text"
                      ...
                      <Button type="button" variant="outline" className="w-full border-sekkot-gray/30 text-gray-300 hover:bg-sekkot-dark" onClick={() => setShowOtpField(false)}>
                        Back
                      </Button>
                    </form>
                  )}
