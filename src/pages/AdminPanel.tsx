...
const AdminPanel = () => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'in_progress': return 'bg-sekkot-purple';
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select 
                      ...
                      className="w-full rounded-md bg-sekkot-dark border-sekkot-gray/30 focus:border-sekkot-purple p-2 text-sm"
                    >
            ...
            <div className="space-y-4 mb-6">
              ...
              {selectedRequest.admin_response && (
                <div>
                  ...
                  <div className="bg-sekkot-darker p-3 rounded-md mt-1 text-white">
                    {selectedRequest.admin_response}
                  </div>
                </div>
              )}
              ...
              <div>
                ...
                <Textarea 
                  ...
                  className="bg-sekkot-dark border-sekkot-gray/30 focus:border-sekkot-purple mt-1"
                  rows={5}
